			...
			<div class="card mb-3 mb-md-4">
				...
				<div class="card-body">
					...
					<div class="mb-3 mb-md-4 d-flex justify-content-between">
						...
						<div class="h3 mb-0"><a href="productControl" class="btn btn-secondary float-right">Add
						New Product</a></div>
					</div>
						...
						<table border="1" style="width: 100%"
							...
							<thead>
								<tr>
									<th style="font-weight: bolder; font-size: 18px">Product
										ID</th>
									<th style="font-weight: bolder; font-size: 18px"><a style="color:black;" href="/admin/product?field=name">Name</a></th>
									<th style="font-weight: bolder; font-size: 18px">Image</th>
									<th style="font-weight: bolder; font-size: 18px"><a style="color:black;" href="/admin/product?field=price">Price</a></th>
							...
							<c:forEach var="item" items="${page.content}">
								<tr>
									<td>${item.id}</td>
									<td>${item.name}</td>
									<td  style="text-align:center;"><img src="/forUser/images/${item.image}" alt=""
										width="50px" /></td>
									<td>${item.price}</td>
									...
									style="font-size: 14px" class="btn btn-dark btn-xs"> <span
										class="glyphicon glyphicon-remove"></span> Delt
								</a></td>
