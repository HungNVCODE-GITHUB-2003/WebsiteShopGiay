			...
			<div class="card mb-3 mb-md-4">
				...
				<div class="card-body">
					...
					<div class="mb-3 mb-md-4 d-flex justify-content-between">
						<div class="h3 mb-0">Category List</div>
						<div class="h3 mb-0">
							<a href="categoryControl" class="btn btn-secondary float-right">Add
								New Category</a>
						</div>
					</div>
							...
							<c:forEach var="item" items="${page.content}">
								<tr style="text-align: center;">
									...
									<td><a class='btn btn-dark btn-xs'
										...
										class="btn btn-dark btn-xs"> <span
							...
							<nav class="d-flex ml-md-auto d-print-none"
								...
								<ul
									...
									<li class="page-item"><a id="datatablePaginationPrev"
										class="page-link" href="/admin/category?p=0"
									...
									<li class="page-item d-none d-md-block"><a
										...
										href="/admin/category?p=${page.number-1}" data-dt-page-to="0">Prev</a></li>

									<li class="page-item d-none d-md-block"><a
										id="datatablePagination2" class="page-link"
										href="/admin/category?p=${page.number+1}" data-dt-page-to="2">Next</a></li>
