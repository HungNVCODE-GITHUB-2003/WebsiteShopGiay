...
<div id="page" class="product_section layout_padding">
				...
				<div class="col-sm-4 text-center">
					<div class="featured">
						<div class="featured-img featured-img-2"
							style="background-image: url(/forUser/images/img_bg_3.jpg);">
							<h2>Casuals</h2>
							<p>
						...
						<div class="col-12 pb-1">
							<div
								...
								<%-- <form action="/user/list" method="post" class="search-wrap">
									<div class="input-group">
										<input type="search" class="form-control search"
											name="id" placeholder="Category Id?">
										<button class="btn btn-primary submit-search text-center"
											type="submit">
											<i class="icon-search"></i>
										</button>
									...
									<div class="option_container">
										<div class="options">
											...
											<a class="option1" href="/user/cart/add/${item.id}"> Add
												To Cart </a> <a href="/user/product_detail/detail/${item.id}" class="option2"> + Quick
												View </a> 
	...
	<c:forEach var="item" items="${page.content}">
							...
							<div class="col-lg-4 mb-4 text-center">
								...
								<a href="/user/product_detail/detail/${item.id}" class="option2">+ Quick
												View </a> 
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<div class="block-27">
								<ul>
								<a href="/user/search?p=0" class="btn btn-primary">First</a> <a
									href="/user/search?p=${page.number-1}" class="btn btn-primary">Previous</a>
								<a href="/user/search?p=${page.number+1}" class="btn btn-primary">Next</a>
								<a href="/user/search?p=${page.totalPages-1}" class="btn btn-primary">Last</a>
								</ul>
