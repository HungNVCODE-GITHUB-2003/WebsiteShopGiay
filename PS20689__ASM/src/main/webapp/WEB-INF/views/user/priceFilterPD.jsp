...
<div class="col-12 pb-1">
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<div class="block-27">
								<ul>
								<a href="/user/price?p=0" class="btn btn-primary">First</a> <a
									href="/user/price?p=${page.number-1}" class="btn btn-primary">Previous</a>
								<a href="/user/price?p=${page.number+1}" class="btn btn-primary">Next</a>
								<a href="/user/price?p=${page.totalPages-1}" class="btn btn-primary">Last</a>
								</ul>
