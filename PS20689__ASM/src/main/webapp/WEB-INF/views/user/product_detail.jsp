...
<form action="/user/cart/add/${pr.id}" method="POST"
class="order">
	...
	<div class="breadcrumbs">
		<div class="container">
			<div class="row">
				<div class="col">
					<p class="bread">
						<span><a href="/user/index">Home</a></span> / <span>Product
							Details</span>
					</p>
				</div>
			</div>
			...
			<div class="row row-pb-lg product-detail-wrap">
						...
						<%-- <div class="item">
								<div class="product-entry border">
									<a href="#" class="prod-img">
										<img src="/forUser/images/${pr.image}" class="img-fluid" alt="">
									</a>
								</div>
						...
						<div class="item">
							<div class="product-entry border">
								<a href="#" class="prod-img"> <img
									src="/forUser/images/${pr.image}" class="img-fluid " alt="">
								</a>
							</div>
						</div>
						<div class="item">
				...
				<div class="col-sm-4">
					<div class="product-desc">
						...
						<br>
						<p class="price">
							<span>$${pr.price}</span> <span class="rate"> <i
								class="icon-star-full"></i> <i class="icon-star-full"></i> <i
								class="icon-star-full"></i> <i class="icon-star-full"></i> <i
								class="icon-star-half"></i> (SKU: ${pr.id})
							</span>
						</p>
						<br>
