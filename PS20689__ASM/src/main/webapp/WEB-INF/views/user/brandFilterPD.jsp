	...
	<div class="breadcrumbs">
		<div class="container">
			<div class="row">
				<div class="col">
					<p class="bread">
						<span><a href="index.html">Home</a></span> / <span>Men</span>
					</p>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-9 col-xl-9">
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<div class="block-27">
								<ul>
								<a href="/user/brand?p=0" class="btn btn-primary">First</a> <a
									href="/user/brand?p=${page.number-1}" class="btn btn-primary">Previous</a>
								<a href="/user/brand?p=${page.number+1}" class="btn btn-primary">Next</a>
								<a href="/user/brand?p=${page.totalPages-1}" class="btn btn-primary">Last</a>
								</ul>
